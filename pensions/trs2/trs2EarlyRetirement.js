...
export function getTRS2EarlyRetirementFactor({
    retirementAge,
    serviceYears,
    hireDate
}) {
    ...
    if (
        ...
        throw new Error(
            "TRS2 early retirement requires age 55+ and at least 20 years of service."
        );
    }
...
export function applyTRS2EarlyRetirementReduction(
    monthlyBenefit,
    {
        retirementAge,
        serviceYears,
    ...
    const earlyRetirementFactor = getTRS2EarlyRetirementFactor({
        retirementAge,
        serviceYears,
        hireDate
    });
