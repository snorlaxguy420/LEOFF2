...
export function getSERS2EarlyRetirementFactor({
    retirementAge,
    serviceYears,
    hireDate
}) {
    ...
    if (
        ...
        throw new Error(
            "SERS2 early retirement requires age 55+ and at least 20 years of service."
        );
    }
...
export function applySERS2EarlyRetirementReduction(
    monthlyBenefit,
    {
        retirementAge,
        serviceYears,
    ...
    const earlyRetirementFactor = getSERS2EarlyRetirementFactor({
        retirementAge,
        serviceYears,
        hireDate
    });
